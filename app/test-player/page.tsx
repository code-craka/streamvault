  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mx-auto max-w-4xl">
        <div className="mb-8">
          <h1 className="mb-2 text-3xl font-bold">HLS Player Test</h1>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="bg-muted mt-4 rounded-lg p-4">
              <h4 className="mb-2 font-medium">Player Features:</h4>
        ...
        <Card className="mt-6">
          ...
          <CardContent>
            <div className="grid gap-4 text-sm">
              ...
              <div>
                <strong>Native HLS Support:</strong>{' '}
                {typeof window !== 'undefined' &&
                document
                  .createElement('video')
