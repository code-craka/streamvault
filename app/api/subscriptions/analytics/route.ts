...
export async function GET(request: NextRequest) {
  try {
    ...
    const tierMetrics: Record<string, SubscriptionMetrics> = {
      basic: {
        ...
        monthlyRecurringRevenue:
          basicAnalytics.subscriptionsByTier.basic * 9.99,
        annualRecurringRevenue:
          basicAnalytics.subscriptionsByTier.basic * 9.99 * 12,
      ...
      premium: {
        ...
        conversionRate: 0,
        monthlyRecurringRevenue:
          basicAnalytics.subscriptionsByTier.premium * 19.99,
        annualRecurringRevenue:
          basicAnalytics.subscriptionsByTier.premium * 19.99 * 12,
        customerAcquisitionCost: 0,
        monthlyGrowthRate: 0,
        retentionRate: 0,
      },
      pro: {
        ...
        annualRecurringRevenue:
          basicAnalytics.subscriptionsByTier.pro * 29.99 * 12,
        customerAcquisitionCost: 0,
        monthlyGrowthRate: 0,
        retentionRate: 0,
      },
    ...
    const trendData = generateTrendData(
      basicAnalytics.monthlyRecurringRevenue,
      monthsToShow
    )
    ...
    const analyticsData = {
      overview: {
        ...
        totalUsers,
        conversionRate:
          totalUsers > 0 ? basicAnalytics.activeSubscriptions / totalUsers : 0,
        churnRate:
          basicAnalytics.activeSubscriptions > 0
            ? canceledSubscribers / basicAnalytics.activeSubscriptions
            : 0,
