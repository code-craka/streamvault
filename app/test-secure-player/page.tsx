...
const SAMPLE_VIDEOS = [
  {
    ...
    description: 'Learn about the features and capabilities of our streaming platform.',
  ...
  },
  {
    ...
    description: 'Deep dive into professional streaming setups and optimization strategies.',
  ...
  },
  {
    ...
    description: 'Exclusive content for Pro subscribers covering enterprise-level streaming infrastructure.',
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-2">Secure VOD Player Test</h1>
          <p className="text-muted-foreground">
            Test the secure video-on-demand player with signed URLs and subscription validation
          </p>
        </div>
        ...
        <Card className="mb-6">
          <CardHeader>
            ...
            <CardDescription>
              Choose a video to test different subscription tiers and security features
            </CardDescription>
          </CardHeader>
          <CardContent>
                ...
                >
                  <div className="flex items-start justify-between">
                    ...
                    <Badge className={TIER_COLORS[video.requiredTier]}>
                      {TIER_ICONS[video.requiredTier]} {video.requiredTier.toUpperCase()}
                    </Badge>
                  </div>
                </div>
              ))}
          ...
          <CardContent>
            <div className="grid gap-4 text-sm">
              <div className="flex items-center space-x-2">
                ...
                <span><strong>Signed URLs:</strong> 15-minute expiration with automatic refresh</span>
              </div>
              <div className="flex items-center space-x-2">
                <span className="text-green-600">✅</span>
                <span><strong>Subscription Validation:</strong> Real-time tier checking via Clerk</span>
              </div>
              <div className="flex items-center space-x-2">
                <span className="text-green-600">✅</span>
                <span><strong>Session Management:</strong> Secure playback sessions with refresh tokens</span>
              </div>
              <div className="flex items-center space-x-2">
                <span className="text-green-600">✅</span>
                <span><strong>Access Logging:</strong> Comprehensive analytics and audit trails</span>
              </div>
              <div className="flex items-center space-x-2">
                <span className="text-green-600">✅</span>
                <span><strong>Error Handling:</strong> Graceful fallbacks and retry mechanisms</span>
              </div>
              <div className="flex items-center space-x-2">
                <span className="text-green-600">✅</span>
                <span><strong>Content Protection:</strong> No direct file access, secure streaming only</span>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="mt-6">
          ...
          <CardContent>
            <div className="space-y-2 text-sm font-mono">
              <div><strong>GET</strong> /api/videos/[videoId]/signed-url?tier={testTier}</div>
              <div><strong>POST</strong> /api/videos/[videoId]/signed-url</div>
              <div><strong>POST</strong> /api/videos/[videoId]/refresh-url</div>
              <div><strong>GET</strong> /api/videos/[videoId]/refresh-url?sessionId=...&refreshToken=...</div>
            </div>
          </CardContent>
        </Card>
      </div>
