          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex-1">
              ...
              <div className="mt-2 flex items-center space-x-2">
                <Badge variant="secondary">{streamVaultUser.role}</Badge>
                <Badge
                  variant={
                    streamVaultUser.subscriptionStatus === 'active'
                      ? 'default'
                      : 'outline'
                  }
                >
                  {getSubscriptionTierDisplayName(
                    streamVaultUser.subscriptionTier
                  )}
                </Badge>
                <Badge variant="outline">
                  {getSubscriptionStatusText(
                    streamVaultUser.subscriptionStatus
                  )}
                </Badge>
              </div>
            </div>
