import { contentModerator, moderateText } from '@/lib/security/content-moderation'
...
describe('Content Moderation', () => {
  describe('moderateText', () => {
    ...
    it('should detect profanity', async () => {
      const result = await moderateText('This content has spam words', 'user123')
    ...
    it('should detect personal information', async () => {
      const personalInfo = 'My email is test@example.com and phone is 123-456-7890'
    ...
    it('should detect unauthorized links', async () => {
      const linkContent = 'Check out this suspicious site: https://malicious-site.com'
    ...
    it('should allow authorized links', async () => {
      const linkContent = 'Check out this video: https://youtube.com/watch?v=123'
      const result = await moderateText(linkContent, 'user123')
    ...
    it('should handle multiple violations', async () => {
      const violatingContent = 'SPAM SPAM SPAM!!! Contact me at test@example.com https://bad-site.com'
