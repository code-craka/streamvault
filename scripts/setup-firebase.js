...
if (fs.existsSync(serviceAccountPath)) {
  ...
  console.log(
    '   Please ensure the service account file is in the .gcp directory'
  )
}
...
console.log(
  '3. Test configuration: curl http://localhost:3000/api/firebase/config'
)
...
console.log(
  '- Enable Firestore API: https://console.developers.google.com/apis/api/firestore.googleapis.com/'
)
