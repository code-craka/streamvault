...
if (!apiKey.startsWith('AIza')) {
  console.warn('⚠️  GOOGLE_AI_API_KEY does not start with expected prefix "AIza"');
}
...
try {
  ...
  if (vscodeSettings['gemini.apiKey'] || vscodeSettings['google.ai.apiKey'] || vscodeSettings['googleAI.apiKey']) {
...
console.log('6. 🔄 If still not working, use Command Palette: "Gemini Code Assist: Sign In"');