...
const CACHEABLE_ROUTES = ['/api/streams', '/api/videos', '/api/user/profile']
...
self.addEventListener('push', event => {
  ...
  event.waitUntil(self.registration.showNotification('StreamVault', options))
})
